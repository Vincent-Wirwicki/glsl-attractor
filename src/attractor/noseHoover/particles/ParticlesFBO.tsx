...
import SimMatNoseHoover from "../shaders/sim/SimMat";
...
declare module "@react-three/fiber" {
  interface ThreeElements {
    simMatNoseHoover: Object3DNode<SimMatNoseHoover, typeof SimMatNoseHoover>;
  }
}
  ...
  return (
    <>
      <PortalMesh uvs={uvs} positions={positions} scene={scene}>
        {/* some children */}
        <simMatNoseHoover ref={simMatRef} args={[size]} />
      </PortalMesh>
      <PointsGeo
        color={color}
